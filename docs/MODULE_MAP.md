...
| `getboot-limiter` | 分布式限流 | 需要声明式限流或统一限流规则时 | `getboot-coordination` | `getboot.limiter.*` + `getboot.coordination.redisson.*` | `slidingwindow.redisson` | [getboot-limiter/README.md](../getboot-limiter/README.md) |
