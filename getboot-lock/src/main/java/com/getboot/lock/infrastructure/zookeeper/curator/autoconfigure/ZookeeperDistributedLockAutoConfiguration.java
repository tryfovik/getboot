 ...
 */
package com.getboot.lock.infrastructure.zookeeper.curator.autoconfigure;

import com.getboot.lock.api.properties.LockProperties;
import com.getboot.lock.infrastructure.zookeeper.curator.aspect.ZookeeperDistributedLockAspect;
...
@ConditionalOnExpression(
        "'${getboot.lock.type:}' == 'zookeeper' and '${getboot.lock.zookeeper.enabled:false}' == 'true'"
)
